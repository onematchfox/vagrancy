...
```shell
wget https://github.com/onematchfox/vagrancy/releases/download/0.0.7/vagrancy-0.0.7-linux-x86_64.tar.gz
tar xvf vagrancy-0.0.7-linux-x86_64.tar.gz
cd vagrancy-0.0.7-linux-x86_64
./vagrancy
```
...
wget https://github.com/onematchfox/vagrancy/releases/download/0.0.7/vagrancy-0.0.7-linux-x86_64.tar.gz
tar xvf vagrancy-0.0.7-linux-x86_64.tar.gz
cp vagrancy-3-linux-x86_64/config.yml vagrancy-0.0.7-linux-x86_64/
cd vagrancy-0.0.7-linux-x86_64/
